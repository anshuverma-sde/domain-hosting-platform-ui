...
import { HostingPlans } from "@/features/hosting/components"
    ...
    <div className="flex flex-col min-h-screen">
            ...
            {[
              ...
              <motion.div key={index} className="text-center" variants={fadeInUp} whileHover={{ scale: 1.05 }}>
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg">
                  <stat.icon className="h-8 w-8 mx-auto mb-4" style={{ color: theme.colors.primary }} />
                ...
                <Card className="h-full hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50 dark:from-slate-800 dark:to-slate-900">
                  <CardContent className="pt-6">
                    <motion.div className="text-center" whileHover={{ y: -5 }} transition={{ duration: 0.2 }}>
                      <div
                        className="p-4 rounded-full inline-flex mb-6 shadow-lg"
                        style={{ 
      ...
      <section className="py-16 bg-gray-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Web Hosting Plans</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Reliable, high-performance hosting solutions for your website
            </p>
          </motion.div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex mb-4">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star key={i} className="h-5 w-5 fill-current" style={{ color: theme.colors.warning }} />
                      ))}
                    </div>
      ...
      <section className="py-16 relative overflow-hidden">
        <div 
          ...
          style={{ 
            background: `linear-gradient(to right, ${theme.colors.primary}, #9333ea, #e11d48)`,
            opacity: 0.9
          }}
        ></div>
